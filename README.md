...
Rolling time-series of UK job-market open-position counts in five target areas — Agentic AI / LLM, HW / Power / SI / PI, FPGA / RTL, DSP, Electronics Engineer — split between UK-wide and Yorkshire + Greater Manchester windows of 7 days and 30 days.
...
| --- | --- |
| `date` | ISO YYYY-MM-DD |
| `area` | One of `Agentic AI / LLM`, `HW / Power / SI / PI`, `FPGA / RTL`, `DSP`, `Electronics Engineer` |
